...
\begin{aline}
\\P=(a^2+c^2-b^2)/2(a)
\\P=(5.5^2+5.5^2-5.5^2)/2(5.5)
\\P=-8.25
\end{aline}
\\
let the vertices of $\triangle  ABC$ and be
\begin{align}
\vec{A} = \myvec{p\\c}, \vec{B} = \myvec{0\\0}, \vec{C} = \myvec{a\\0}
\end{align}
\\Now, Vertices of given $\triangle ABC$ can be written as,
\begin{align}
\vec{A}=\myvec{p\\c}=\myvec{p\\5.5}, \vec{B}=\myvec{0\\0}, \vec{c}=\myvec{a\\0}=\myvec{5.5\\0} 
\end{align}
\\
